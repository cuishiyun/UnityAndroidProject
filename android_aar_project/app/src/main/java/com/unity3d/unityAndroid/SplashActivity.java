...
public class SplashActivity extends Activity implements SplashADListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >= 23){
            ...
            fetchSplashAD(this, container, skipView, AdConfig.getInstance().getAppId(), getPosId(), this, 0);
        }
    ...
    {
        //        this.loadBannerAd();
//        new UnifiedInterstitialADActivity(this);//插屏
        RewardVideoUtils.initRewardVideo(this);
    }
    ...
    private String getPosId() {
        ...
        return TextUtils.isEmpty(posId) ?  AdConfig.getInstance().getSplashId() : posId;
    }
    ...
    private void next() {
        if (canJump) {
            if (needStartDemoList) {
                this.startActivity(new Intent(this, UnityAppActivity.class));
            }
            this.finish();
        } else {
            canJump = true;
...
//    }
    ...
    public void onNoAD(AdError adError) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (needStartDemoList) {
                    SplashActivity.this.startActivity(new Intent(SplashActivity.this, UnityAppActivity.class));
                }
